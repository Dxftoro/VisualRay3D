...
#define VR_LOGIMPORTANT(MESSAGE_STR)		vray::LogService::getGameLogger()->logImportant(MESSAGE_STR)
...
#define VR_ENGINE_LOGIMPORTANT(MESSAGE_STR)	vray::LogService::getEngineLogger()->logImportant(MESSAGE_STR)